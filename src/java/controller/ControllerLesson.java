    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (service.equals("learnLesson")) {
                ...
                if (daoLesson.checkLessonIDExist(Integer.parseInt(lessonID))) {
                    int minPDFId = daoPDF.getMinPDFIDByLessonID(Integer.parseInt(lessonID));
                    int maxPDFId = daoPDF.getMaxPDFIDByLessonID(Integer.parseInt(lessonID));
                    int maxVideoId = daoLesson.getMaxVideoIDByLessonID(Integer.parseInt(lessonID));
                    int minVideoIdNextLesson = daoLesson.getMinVideoIDByLessonID((Integer.parseInt(lessonID) + 1));
                    int minVideoId = daoLesson.getMinVideoIDByLessonID(Integer.parseInt(lessonID));
                    if (videoID != null) {
                        ...
                        } else if (videoId == minVideoId && daoLesson.checkLessonIDExist(Integer.parseInt(lessonID) - 1)) {
                            int maxPDFIdPrevious = daoPDF.getMaxPDFIDByLessonID(Integer.parseInt(lessonID) - 1);

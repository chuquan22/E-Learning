...
<html lang="en">
    ...
    <body>
        ...
        <form action="Teacher?teacher=updateCourse" method="post">
            <input hidden name="courseID" value="<%=co.getCourseID()%>">
            <div class="container pt-4 px-4">
                        ...
                        <div class="bg-light rounded h-100 p-4">
                            ...
                            <div class="form-floating mb-3">
                                <select name="courseCategory" class="form-select" id="floatingSelect"
                                    ...
                                    <option value="<%=ca.getCategoryID()%>" <%=(ca.getCategoryID() == co.getCategoryID() ? "selected" : "")%>><%=ca.getCategoryName()%></option>
                            ...
                            <div class="form-floating mb-3">
                                <textarea name="description" class="form-control" placeholder="Description"                                     
                                          id="floatingDescription" style="height: 150px;"><%=co.getDescription()%></textarea>
                ...
                <div class="row">
                    <div class="">
                        <button type="submit" name="updateCourse" class="btn btn-primary mt-5 col-12 py-2 text-center fs-5">Update Course</button>
                    </div>
                </div>
            </div>           

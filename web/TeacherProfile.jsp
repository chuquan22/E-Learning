            ...
            <div class="row vh-100" >
                ...
                <div class="col-lg-9">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <img src="<%=teacher.getImage() == null ? "https://static2.yan.vn/YanNews/2167221/202102/facebook-cap-nhat-avatar-doi-voi-tai-khoan-khong-su-dung-anh-dai-dien-e4abd14d.jpg" : teacher.getImage()%>" alt="" width="150" height="150"><br>
                        </div>
                    </div>

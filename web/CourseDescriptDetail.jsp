        ...
        <div class="container-fluid py-5 wow fadeInDown row" data-wow-delay="0.1s">
            ...
            <div class="col-8 row">
                <div class="border row align-items-center " >
                    <div class="h5  m-2"><%=courseDescript%></div>
                </div>
                <div class="border row">
                    <div class="my-2">
                        <ol class="list-group list-group-numbered">
                            ...
                            <div class="text-center justify-content-center align-items-center fs-1 fw-bold text-danger">This Course Is Under Development Process</div>
                            <%}%>
                        </ol>
                    </div>
                </div>
